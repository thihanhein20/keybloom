...
export const metadata:Metadata={title:"Keybloom — Your 3D Desk Friend",description:"A cute, hand-built interactive 3D mechanical keyboard and monitor.",icons:{icon:"/favicon.svg"}};
